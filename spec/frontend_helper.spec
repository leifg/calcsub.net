...
describe FrontendHelper, "when receiving ipv4 address" do
  ...
  it "should return print out the correct IP-address for local ipv4 address #{Local_IPv4_address1_to_format}" do 
    ...
    FrontendHelper.new(Local_IPv4_address1_to_format).dotted_hash.should == expected_result
  end
  ...
  it "should return print out the correct IP-address for ipv4 address #{IPv4_address2_to_format}" do 
    ...
    FrontendHelper.new(IPv4_address2_to_format).dotted_hash.should == expected_result
  end
  ...
  it "should return print out the correct IP-address for ipv4 address #{IPv4_address3_to_format}" do 
    ...
    FrontendHelper.new(IPv4_address3_to_format).dotted_hash.should == expected_result
  end
  ...
  it "should return print out the correct IP-address for ipv4 address #{IPv4_address4_to_format}" do 
    ...
    FrontendHelper.new(IPv4_address4_to_format).dotted_hash.should == expected_result
  end
  ...
  it "should return print out the correct IP-address for ipv4 address #{IPv4_address5_to_format}" do 
    ...
    FrontendHelper.new(IPv4_address5_to_format).dotted_hash.should == expected_result
  end
end

describe FrontendHelper, "when receiving ipv6 address" do
  ...
  it "should print out the correct IP-address for ipv6 address #{Local_IPv6_address1_to_format}" do 
    ...
    FrontendHelper.new(IpRange.new(Local_IPv6_address1_to_format)).dotted_hash.should == expected_result
  end
  ...
  it "should print out the correct IP-address for ipv6 address #{Local_IPv6_address2_to_format}" do 
    ...
    FrontendHelper.new(IpRange.new(Local_IPv6_address2_to_format)).dotted_hash.should == expected_result
  end
  ...
  it "should print out the correct IP-address for ipv6 address #{Local_IPv6_address3_to_format}" do 
    ...
    FrontendHelper.new(IpRange.new(Local_IPv6_address3_to_format)).dotted_hash.should == expected_result
  end
  ...
  it "should print out the correct IP-address for ipv6 address #{Local_IPv6_address4_to_format}" do 
    ...
    FrontendHelper.new(IpRange.new(Local_IPv6_address4_to_format)).dotted_hash.should == expected_result
  end
  ...
  it "should print out the correct IP-address for ipv6 address #{Local_IPv6_address5_to_format}" do 
    ...
    FrontendHelper.new(IpRange.new(Local_IPv6_address5_to_format)).dotted_hash.should == expected_result
  end
  ...
  it "should print out the correct IP-address for ipv6 address #{IPv6_address1_to_format}" do 
    ...
    FrontendHelper.new(IpRange.new(IPv6_address1_to_format)).dotted_hash.should == expected_result
  end
  ...
  it "should print out the correct IP-address for ipv6 address #{IPv6_address2_to_format}" do 
    ...
    FrontendHelper.new(IpRange.new(IPv6_address2_to_format)).dotted_hash.should == expected_result
  end
end