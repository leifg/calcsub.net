...
describe FrontendFormatHelper, "when receiving ipv6 address" do
  ...
  Local_IPv6_address1_to_format = IpRange.new("fe80:0000:0000:0000:0202:b3ff:fe1e:8329/10")
  Local_IPv6_address2_to_format = IpRange.new("fe80::1234:0000:0222:b3fe:fefe:6201/128")
  Local_IPv6_address3_to_format = IpRange.new("fe80:4218:192:0:222:4a6b:2122:6208/124")
  Local_IPv6_address4_to_format = IpRange.new("fe80:9271::4a6b:18e3:17b5/127")
  IPv6_address1_to_format = IpRange.new("2002::/3")
  IPv6_address2_to_format = IpRange.new("2003:1985::/32")
    
  it "should return print out the correct IP-address for ipv6 address #{Local_IPv6_address1_to_format}" do 
    expected_result = {:net => "fe", :mixed => "8", :host => "0:0000:0000:0000:0202:b3ff:fe1e:8329"}
    FrontendFormatHelper.new(Local_IPv6_address1_to_format).dotted_hash.should == expected_result
  end
  
  it "should return print out the correct IP-address for ipv6 address #{Local_IPv6_address2_to_format}" do 
    expected_result = {:net => "fe80:0000:1234:0000:0222:b3fe:fefe:6201", :mixed => nil, :host => nil}
    FrontendFormatHelper.new(Local_IPv6_address2_to_format).dotted_hash.should == expected_result
  end
  
  it "should return print out the correct IP-address for ipv6 address #{Local_IPv6_address3_to_format}" do 
    expected_result = {:net => "fe80:4218:0192:0000:0222:4a6b:2122:620", :mixed => nil, :host => "8"}
    FrontendFormatHelper.new(Local_IPv6_address3_to_format).dotted_hash.should == expected_result
  end
  ...
  it "should return print out the correct IP-address for ipv6 address #{Local_IPv6_address4_to_format}" do 
    expected_result = {:net => "fe80:9271:0000:0000:0000:4a6b:18e3:17b", :mixed => "5", :host => nil}
    FrontendFormatHelper.new(Local_IPv6_address4_to_format).dotted_hash.should == expected_result
  end
  
  it "should return print out the correct IP-address for ipv6 address #{IPv6_address1_to_format}" do 
    expected_result = {:net => nil, :mixed => "2", :host => "002:0000:0000:0000:0000:0000:0000:0000"}
    FrontendFormatHelper.new(IPv6_address1_to_format).dotted_hash.should == expected_result
  end
  
  it "should return print out the correct IP-address for ipv6 address #{IPv6_address2_to_format}" do 
    expected_result = {:net => "2003:1985:", :mixed => nil, :host => "0000:0000:0000:0000:0000:0000"}
    FrontendFormatHelper.new(IPv6_address2_to_format).dotted_hash.should == expected_result
  end
end